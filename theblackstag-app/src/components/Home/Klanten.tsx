  ...
  return (
    <section className="container md:pb-32 my-12">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <h3 className="w-fit text-4xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl leading-none bg-linear-to-r from-tbsblue to-tbsgreen bg-clip-text text-transparent font-bold pb-2 md:pb-0">
          {content.title}
        </h3>
